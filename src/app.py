...
st.markdown('<div class="title">❤️ Health Risk Prediction System</div>', unsafe_allow_html=True)
...
X_encoded = pd.get_dummies(X, columns=["Gender","Smoking Status","Chronic Disease History"])
...
with col2:
    ...
    disease = st.selectbox("Disease 🏥", ["None","Diabetes","Heart Disease","Hypertension"])
